...
<div id="content">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title"><span class="glyphicon glyphicon-cloud"></span>&nbsp;<span style="vertical-align:middle;font-weight:bold;"><?php echo $heading_title; ?></span></h3>
            	...
            	<div class="form-group">
                	...
                	<ul class="dropdown-menu" role="menu">
                    	<?php foreach ($stores  as $st) { ?>
                    		<li><a href="index.php?route=module/weatherwidget&store_id=<?php echo $st['store_id'];?>&token=<?php echo $this->session->data['token']; ?>"><?php echo $st['name']; ?></a></li>
                    	<?php } ?> 
                	</ul>
            	</div>
            </div>
            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form"> 
                ...
                <div class="tabbable">
                    ...
                    <div class="tab-content">
                  	    <div id="main_settings" class="tab-pane fade"><?php require_once(DIR_APPLICATION.'view/template/module/weatherwidget/tab_settings.php'); ?></div>
                        <div id="control_panel" class="tab-pane fade"><?php require_once(DIR_APPLICATION.'view/template/module/weatherwidget/tab_controlpanel.php'); ?></div>
